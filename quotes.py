bob_quotes = ["Less talking, more games!", "I'll fucking bum you, Spamiibo!", "We really need to bum Dylan!",
              "Oh shit, I didn't realise he was here, abort abort abort!", "Yeah, well they're fucking losers mate.",
              "If you can't laugh at yourself, you have no right to laugh at anyone else!", "I can't believe I suported that guy.",
              "WHAT DID YOU SAY????", "Nice, nice."]

henri_quotes = ["Spence, if I wanted to get a second monitor, would I need a second keyboard and mouse?",
